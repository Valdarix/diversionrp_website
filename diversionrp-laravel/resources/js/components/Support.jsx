...
/**
 * Supporters page acknowledging community contributions.
 */
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      <main className="flex-grow container mx-auto py-16 px-4">
        <h1 className="text-4xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-pink-500">Supporters</h1>
        <p className="text-gray-300">A big thanks to everyone who keeps the server running!</p>
      </main>
    </div>
  );
}
